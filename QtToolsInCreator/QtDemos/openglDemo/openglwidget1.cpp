...
void OpenglWidget1::initShaderByQt()
{
    shaderPro.addShaderFromSourceFile(QOpenGLShader::Vertex,
                                      ":/Shaders/shaders/demo1.vert");
    shaderPro.addShaderFromSourceFile(QOpenGLShader::Fragment,
                                      ":/Shaders/shaders/demo1.frag");
    shaderPro.link();
}

void OpenglWidget1::initShaderByQpengl()
{
